...
We use an app created by Serverless - https://github.com/serverless/examples/tree/master/aws-ruby-sinatra-dynamodb-api, use then to deploy de app in your AWS environment.

# Enable Trace ingest on Dynatrace
### Create an Api-Token with "Ingest Opentelemetry Trace" permission
