# -*- encoding: utf-8 -*-
# stub: opentelemetry-common 0.19.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/issues", "changelog_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-common/v0.19.1/file.CHANGELOG.html", "documentation_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-common/v0.19.1", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/tree/main/common" } if s.respond_to? :metadata=
