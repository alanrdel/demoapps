# -*- encoding: utf-8 -*-
# stub: opentelemetry-exporter-jaeger 0.20.0 ruby lib

Gem::Specification.new do |s|
  s.name = "opentelemetry-exporter-jaeger".freeze
  s.version = "0.20.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/issues", "changelog_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-exporter-jaeger/v0.20.0/file.CHANGELOG.html", "documentation_uri" => "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-exporter-jaeger/v0.20.0", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby/tree/main/exporter/jaeger" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["OpenTelemetry Authors".freeze]
  s.date = "2021-08-16"
  s.description = "Jaeger trace exporter for the OpenTelemetry framework".freeze
  ...
  s.summary = "Jaeger trace exporter for the OpenTelemetry framework".freeze
